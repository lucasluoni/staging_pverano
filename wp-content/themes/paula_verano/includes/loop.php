  ...
  <!-- <div class="content"> -->
    ...
    <section id="call_to_action">
      <div class="container-fluid px-0 py-5 bg-white insetShedou">
        <div class="container py-3">
          ...
          <div class="row">
            <div class="col text-center">         
              ...
              <h1 class="text-uppercase roxo mb-0">vamos trabalhar juntos?</h1>
        ...
        <div class="row">
          <div class="col text-center">
            <a class="btn bgAmarelo my-3 rounded-0 text-uppercase text-white" href="<?php echo get_site_url(); ?>/#contato" role="button">entre em contato</a>
          </div>
        </div>
